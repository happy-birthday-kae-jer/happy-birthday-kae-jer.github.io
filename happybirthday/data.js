const data1 = [
  {
    ...
    words: `Happy Birthday Mike!!! 🎉🥳You're 1 year older now but also 1 year wiser jkjk! 🤪😎Hope you have an amazing time in Taiwan in the coming break! -Justin
    `,
  },
  { pic: './pics/01.jpg' },
  {
...
const data2 = [
  { pic: './pics/02.jpg' },
  {
    ...
    words: `Hey Mike, 感謝身為大家長（？）的你總是帶給大家美好的酒、咖啡與高品質的生活態度。真心的為朋友付出、盡力投入每一件事情是我在你身上看到發光的點，也是我努力學習的特質。很高興能在這裡認識你！
    `,
  },
  { pic: './pics/07.jpg' },
  {
...
const data3 = [
  {
    ...
    words: `生日快樂 ☺️ Thank you for being the big brother with very cool toys in our group，常常默默照顧大家，還有負責提升我們生活品質跟品味～太喜歡我們的對話了哈哈哈尤其是八卦的部分😂  我就在這邊少寫三句話，等隔離出來陪你多喝三杯比較實際！期待我們一起去看聖誕樹🎄 Stay Healthy! And drink wine :)
    `,
  },
  { pic: './pics/03.jpg' },
  {
  ...
  { pic: './pics/08.jpg' },
  {
    ...
    words: `麥克安安，生日快樂！感謝你做為那個在團體裡總是默默照顧大家的人，不管是物理上還是心理層面的付出。跟你相處總是感覺到生活品質被大幅提升，雖然我明顯沒什麼長進但總還是會有品味提升的短暫錯覺。很欣賞你對人很直率坦白，也很高興能跟你合作。感謝你的生日酒，也希望你會喜歡這次的生日，我會把網站的原始碼作為生日禮物傳給你的 🤩  對酒當歌 🍺  人生幾何 🥳  生日快樂，一切順心！ By 程維 2020.12.13
    `,
  },
  { pic: './pics/15.jpg' },
  { pic: './pics/16.jpg' },
...
const data4 = [
  { pic: './pics/04.jpg' },
  {
    ...
    words: `邁哥: 謝謝你之前分享路況調查的成果，還有最後一秒的 AML 偷吃步。
            緊急的時刻你總是很罩，分享的經驗(跟吃的)也都是高品質。
            聚會時你也總是拉高群組品味的那個人。 有一種 "這就是大人的世界啊~~"。
            的感覺，負責且值得信賴。 你煩惱的事情或許我無法幫你解決。
            但是跟吃的一樣一起分享(?)的話也能迸出新滋味。 生日快樂，等你出關再聚 -久山`,
  },
  { pic: './pics/09.jpg' },
  {
...
const data5 = [
  {
    ...
    words: `Hi Mike, wishing you a happiest birthday 🎂! Am really grateful for you and all the effort you put to make people feel cared for. Wishing you another year full of things to be excited about, grateful for, and remembered. Also, hang on with all the projects, you got this! Let’s play with the boosted board soon! -Angelica
    `,
  },
  { pic: './pics/05.jpg' },

  {
    ...
    words: `楷哲生日快樂～～雖然每次都偷酸你老哈哈哈，但我明白你有顆年輕的心！那比起蛋糕上有幾根蠟燭重要得多太多了，希望我31(還是32？）歲的時候也能跟你一樣，依舊大膽無畏！祝 未來的一年一切順利也不忘快樂生活 ：）
